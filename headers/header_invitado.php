...
<head>
    ...
    <title>Contratos - Invitado</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light">
        <a class="navbar-brand" href="control_contratos.php">Sistema de contratos</a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item active">
                    <a class="nav-link" href="control_contratos.php">Inicio</a>
                </li>
            </ul>
            <div class="my-lg-0">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
